...
const SubmitBuildPage: NextPage = () => {
  ...
  function handleNoteUpdated(originalBuildStep: TBuildStep, newNoteValue: string) {
    setBuildSteps(
      buildSteps.map((buildStep) => buildStep == originalBuildStep ? {
        ...buildStep,
        note: newNoteValue,
      } : buildStep)
    )
  ...
  return (
    <>
      ...
      <main className="container flex flex-col gap-8 bg-gray-800 m-auto pb-12 pt-12 text-white">
        ...
        >
          ...
          <div className="flex">
                  ...
                  {buildSteps.map((buildStep, idx) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-3">
                        <input
                          className="bg-gray-700 p-1 hover:bg-gray-500 focus:bg-gray-500"
            ...
            <div className="flex w-1/2 gap-8 px-6">
